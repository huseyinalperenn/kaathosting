        ...
        <header id="header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-6 link">
                            <div class="infonews-nav float-end">
                                ...
                                <a href="contact" title="Contact Us" class="iconews"><i
                                        class="ico-bell f-18 w-icon"></i></a>
                                <a href="login" title="Login" class="iconews"><i
                        ...
                        <div class="row align-items-center">
                            <div class="col-2 col-md-2">
                                <a href="index">
                                    ...
                                    <img class="svg logo-menu d-none" src="./assets/img/logo-light.svg"
                                        alt="logo Antler">
                                </a>
                            </div>
                                ...
                                <div class="navigation float-end">
                                    ...
                                    <ul class="main-menu nav navbar-nav navbar-right">
                                        <li class="menu-item menu-item-has-children me-2">
                                            ...
                                            <div class="badge bg-pink me-4 wow animated shake delay-1s visible">NEW
                                            </div>
                                            <ul class="sub-menu dropdown bg-colorstyle">
                                                <li class="menu-item"><a class="mergecolor" href="index"
                                                        data-i18n="[html]submenu.homedefault"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="homevideo"
                                                        data-i18n="[html]submenu.homevideo"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="homeimage"
                                                        data-i18n="[html]submenu.homeimage"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="homegaming"
                                                        data-i18n="[html]submenu.homegaming"> </a>
                                                    <div class="menu badge feat bg-purple">NEW</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor" href="home3d"
                                                        data-i18n="[html]submenu.home3d"> </a>
                                                    <div class="menu badge feat bg-purple">NEW</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor"
                                                        href="http://inebur.com/whmcs/?systpl=antler&carttpl=antler&language=arabic"
                                        ...
                                        <li class="menu-item menu-item-has-children me-2">
                                            <a class="m-0 pe-1 v-stroke" href="#" data-i18n="[html]header.services">
                                            </a>
                                                ...
                                                <div class="service-list">
                                                    <div class="service">
                                                        ...
                                                        <div class="media-body">
                                                            <a class="menu-item mergecolor" href="shared-hosting"
                                                                data-i18n="[html]submenu.hosting"> </a>
                                                            <p class="seccolor">Sed ut perspiciatis unde omnis iste
                                                                natus</p>
                                                        </div>
                                                    </div>
                                                    <div class="service">
                                                        <img class="svg" src="./assets/fonts/svg/reseller.svg"
                                                            alt="Cloud Reseller">
                                                        <div class="media-body">
                                                            <a class="menu-item mergecolor" href="reseller"
                                                                data-i18n="[html]submenu.reseller"> </a>
                                                            <p class="seccolor">Lorem ipsum dolor sit amet, consectetur
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="service">
                                                        ...
                                                        <div class="media-body">
                                                            <a class="menu-item mergecolor" href="dedicated"
                                                                data-i18n="[html]submenu.dedicated"> </a>
                                                            <div class="menu badge feat bg-pink">FILTER</div>
                                                            <p class="seccolor">But I must explain to you how all this
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="service">
                                                        <img class="svg" src="./assets/fonts/svg/vps.svg"
                                                            alt="Cloud VPS">
                                                        <div class="media-body">
                                                            <a class="menu-item mergecolor" href="vps"
                                                                data-i18n="[html]submenu.vps"> </a>
                                                            <div class="menu badge feat bg-grey">SSD</div>
                                                            <p class="seccolor">At vero eos et accusamus et iusto odio
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="service">
                                                        ...
                                                        <div class="media-body">
                                                            <a class="menu-item mergecolor" href="wordpress"
                                                    ...
                                                    <div class="service">
                                                        <img class="svg" src="./assets/fonts/svg/domains.svg"
                                                            alt="Domains">
                                                        <div class="media-body">
                                                            <a class="menu-item mergecolor" href="domains"
                                                    ...
                                                    <div class="service">
                                                        ...
                                                        <div class="media-body">
                                                            <a class="menu-item mergecolor" href="developer"
                                                                data-i18n="[html]submenu.developer"> </a>
                                                            <p class="seccolor">ed ut perspiciatis unde omnis iste natus
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="container">
                                                    <div class="row">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <div class="top-head">
                                                                            ...
                                                                            <div class="menu-item c-grey mergecolor"
                                                                                data-i18n="[html]submenu.services">
                                                                            </div>
                                                                        </div>
                                                                        <hr>
                                                                        <ul>
                                                                            ...
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="email"
                                                                                    data-i18n="[html]submenu.email">
                                                                                </a></li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="magento"
                                                                                    data-i18n="[html]submenu.magento">
                                                                                </a></li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="gsuite"
                                                                                    data-i18n="[html]submenu.gsuite">
                                                                                </a></li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="iptv"
                                                                            ...
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="gaming"
                                                                                    data-i18n="[html]submenu.gaming">
                                                                                </a>
                                                                                <div class="badge inside bg-pink">NEW
                                                                                </div>
                                                                            </li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="radiostream"
                                                                                    data-i18n="[html]submenu.radiostream">
                                                                                </a>
                                                                                <div class="badge inside bg-pink">NEW
                                                                                </div>
                                                                            </li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="cryptotrading"
                                                                                    data-i18n="[html]submenu.cryptotrading">
                                                                                </a>
                                                                                <div class="badge inside bg-pink">NEW
                                                                                </div>
                                                                            </li>
                                                                ...
                                                                <div class="col-4 service">
                                                                    <div class="media-body">
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="datacenter"
                                                                                    data-i18n="[html]submenu.datacenter">
                                                                                </a>
                                                                                <div class="badge inside bg-grey">TOP
                                                                                </div>
                                                                            </li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="about"
                                                                                    data-i18n="[html]submenu.about">
                                                                                </a></li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="database"
                                                                                    data-i18n="[html]submenu.database">
                                                                                </a></li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="vpn"
                                                                            ...
                                                                            <li class="menu-item"><a
                                                                                    class="mergecolor disabled"
                                                                                    href="cryptoexchange"
                                                                                    data-i18n="[html]submenu.cryptoexchange">
                                                                                </a>
                                                                                <div class="badge inside bg-pink">NEW
                                                                                </div>
                                                                            </li>
                                                                ...
                                                                <div class="col-4 service">
                                                                    <div class="media-body">
                                                                        ...
                                                                        <ul>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="payments"
                                                                                    data-i18n="[html]submenu.payments">
                                                                                </a>
                                                                                <div class="badge inside bg-pink">NEW
                                                                                </div>
                                                                            </li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="configurator"
                                                                                    data-i18n="[html]submenu.config">
                                                                                </a>
                                                                                <div class="badge inside bg-grey">HOT
                                                                                </div>
                                                                            </li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="cart"
                                                                            ...
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="blog-grid"
                                                                                    data-i18n="[html]submenu.bloggrid">
                                                                                </a></li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="checkout"
                                                                                    data-i18n="[html]submenu.checkout">
                                                                                </a></li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="soon"
                                                                            ...
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="promos"
                                                                                    data-i18n="[html]submenu.promos">
                                                                                </a> <i
                                                                                    class="fas fa-tags c-pink ms-2"></i>
                                                                            </li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="blackfriday"
                                                                                    data-i18n="[html]submenu.blackfriday">
                                                                                </a>
                                                                                <div class="badge inside bg-pink">HOT
                                                                                </div>
                                                                            </li>
                                                                            <li class="menu-item"><a class="mergecolor"
                                                                                    href="#"
                                                                                    data-i18n="[html]submenu.blockchainservices">
                                                                                </a>
                                                                                <div class="badge inside bg-grey">SOON
                                                                                </div>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                        ...
                                                        <div class="start-offer col-md-3">
                                                            <div class="inner">
                                                                <h4 class="title my-3">Cloud VPS SSD <br>Get 50%
                                                                    Discount</h4>
                                                                <div class="inner-content mb-4">Enjoy increased
                                                                    flexibility and get
                                                                    the performance you need with SSD Storage.</div>
                                                                <span class="m-0">Before <del class="c-pink">$20.00
                                                                        /mo</del></span><br>
                                                                <h4 class="m-0"><b>Now</b> <b class="c-pink">$9.99
                                                                        /mo</b></h4>
                                                                <a href="vps" class="btn btn-default-pink-fill mt-4">See
                                                                    Plans</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <li class="menu-item menu-item-has-children">
                                            ...
                                            <ul class="sub-menu bg-colorstyle">
                                                <li class="menu-item"><a class="mergecolor"
                                                        href="http://inebur.com/whmcs/?systpl=antler&carttpl=antler"
                                                        target="_blank" data-i18n="[html]submenu.whmcs"> </a>
                                                    <div class="menu badge feat bg-pink">HOT</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor"
                                                        href="http://inebur.com/whmcs/index.php/store/shared-hosting/?systpl=antler&carttpl=antler"
                                                        target="_blank" data-i18n="[html]submenu.orderform"> </a>
                                                    <div class="menu badge feat bg-grey">TOP</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor"
                                                        href="http://inebur.com/antler/email/" target="_blank"
                                                        data-i18n="[html]submenu.whmcsemail"> </a>
                                                    <div class="menu badge feat bg-grey">TOP</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor"
                                                        href="http://inebur.com/antler/newsletter/" target="_blank"
                                                        data-i18n="[html]submenu.whmcsnewsletter"> </a>
                                                    <div class="menu badge feat bg-grey">TOP</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor" href="pricing"
                                                        data-i18n="[html]submenu.pricing"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="sliders"
                                                        data-i18n="[html]submenu.sliders"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="configurator"
                                                        data-i18n="[html]submenu.config"> </a>
                                                    <div class="menu badge feat bg-pink">NEW</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor" href="404"
                                                        data-i18n="[html]submenu.error"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="maintenance"
                                                        data-i18n="[html]submenu.maintenance"> </a>
                                                    <div class="menu badge feat bg-pink">NEW</div>
                                                </li>
                                                <li class="menu-item"><a class="mergecolor" href="login"
                                                        data-i18n="[html]submenu.register"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="login"
                                                        data-i18n="[html]header.login"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="elements"
                                                        data-i18n="[html]submenu.elements"> </a></li>
                                                <li class="menu-item"><a class="mergecolor" href="sections"
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4 service">
                                                                    ...
                                                                    <div class="media-body">
                                                                        ...
                                                                        <p class="seccolor">Eaque ipsa quae ab illo
                                                                            inventore
                                                                ...
                                                                <div class="col-4 service">
                                                                    ...
                                                                    <div class="media-body">
                                                                        <div>
                                                                            <a class="menu-item mergecolor"
                                                                                href="blog-details"
                                                                                data-i18n="[html]submenu.blogdetails">
                                                                            </a>
                                                                            <div class="badge inside bg-pink ms-1">HOT
                                                                            </div>
                                                                        </div>
                                                                        <p class="seccolor">Lorem ipsum dolor sit amet,
                                                                            consectetur
                                                        ...
                                                        <div class="start-offer col-md-3">
                                                            <div class="inner">
                                                                ...
                                                                <div class="inner-content"><span>Call us:</span> <b>+
                                                                        (123)
                                                                        1300-656-1046</b> HeadQuarters - No.01 - 399-0
                                                                    Lorem Street
                                                                    City Melbourne</div>
                                                                <a href="contact"
                                                                    class="btn btn-default-yellow-fill mt-4">Contact
                                                                    Us</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <li class="menu-item">
                                            <a class="pe-0 me-0" href="clientarea.php">
                                                <div class="btn btn-default-yellow-fill question"><span>Kullanıcı Girişi</span><i
                                                        class="fas fa-lock ps-1"></i>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
            ...
            <div class="menu-wrap mobile">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-6">
                            <a href="index"><img class="svg logo-menu d-block" src="./assets/img/logo.svg"
                                    alt="logo Antler"></a>
                            <a href="index"><img class="svg logo-menu d-none" src="./assets/img/logo-light.svg"
                                    alt="logo Antler"></a>
                        </div>
                        <div class="col-6">
                            <nav class="nav-menu float-end d-flex">
                                ...
                                <div class="main-menu bg-seccolorstyle">
                                    <div class="menu-item">
                                        <a class="mergecolor" href="#" data-bs-toggle="dropdown">Home <div
                                    ...
                                    <div class="menu-item">
                                        <a class="mergecolor" href="#" data-bs-toggle="dropdown">Hosting <div
                                    ...
                                    <div class="menu-item">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item menu-item" href="email">Enterprise Email</a>
                                            ...
                                            <a class="dropdown-item menu-item" href="gaming">Gaming Server</a>
                                            <a class="dropdown-item menu-item" href="radiostream">Radio Stream <div
                                                    class="badge inside bg-pink ms-2">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="ddos">DDoS Protection</a>
                                            <a class="dropdown-item menu-item" href="datacenter">Datacenter <div
                                            ...
                                            <a class="dropdown-item menu-item" href="vpn">VPN Solutions <div
                                                    class="badge inside bg-pink ms-2">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="voip">Virtual Numbers</a>
                                            <a class="dropdown-item menu-item" href="voice">Voice Server <div
                                                    class="badge inside bg-pink ms-2">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="seo">Managed SEO Services <div
                                                    class="badge inside bg-pink ms-2">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="payments">Payment Methods <div
                                                    class="badge inside bg-pink ms-2">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="configurator">Configurator <div
                                            ...
                                            <a class="dropdown-item menu-item" href="blackfriday">Blackfriday <div
                                                    class="badge inside bg-pink ms-2">HOT</div></a>
                                            <a class="dropdown-item menu-item" href="cryptotrading">Crypto Trading <div
                                                    class="badge inside bg-pink ms-2">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="cryptoexchange">Crypto Exchange
                                                <div class="badge inside bg-pink ms-2">NEW</div></a>
                                        </div>
                                    </div>
                                    <div class="menu-item">
                                        <a class="mergecolor" href="#" data-bs-toggle="dropdown">Features</a>
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item menu-item"
                                                href="http://inebur.com/whmcs/?systpl=antler" target="_blank">WHMCS
                                                Template <div class="badge inside bg-pink">HOT</div></a>
                                            <a class="dropdown-item menu-item"
                                                href="http://inebur.com/whmcs/cart.php?carttpl=antler&systpl=antler"
                                                target="_blank">Order Form Template <div class="badge inside bg-grey">
                                                    TOP</div></a>
                                            <a class="dropdown-item menu-item" href="http://inebur.com/antler/email/"
                                                target="_blank">HMCS Email Template <div class="badge inside bg-grey">
                                                    TOP</div></a>
                                            <a class="dropdown-item menu-item"
                                                href="http://inebur.com/antler/newsletter/" target="_blank">WHMCS
                                                Newsletter Template <div class="badge inside bg-grey">TOP
                                                </div></a>
                                            ...
                                            <a class="dropdown-item menu-item" href="configurator">Configurator <div
                                                    class="badge inside bg-pink">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="404">404 Error</a>
                                            <a class="dropdown-item menu-item" href="maintenannce">Maintenance <div
                                                    class="badge inside bg-pink">NEW</div></a>
                                            <a class="dropdown-item menu-item" href="login">Register</a>
                                            <a class="dropdown-item menu-item" href="clientarea.php">Kullanıcı Girişi</a>
                                    ...
                                    <div class="menu-item menu-last">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item menu-item" href="knowledgebase-list">Knowlege
                                                List</a>
                                    ...
                                    <div class="float-start w-100 mt-3">
                                        <p class="c-grey-light seccolor"> <small> Phone: + (123) 1300-656-1046</small>
                                        </p>
                                        <p class="c-grey-light seccolor"><small>Email: antler@mail.com</small> </p>
                                    </div>
                                    <div>
                                        <a href="clientarea.php">
                                            <div class="btn btn-default-yellow-fill mt-3">Kullanıcı Girişi</div>
                                        </a>
                                    </div>
                                </div>
                            </nav>
                            ...
                            <a href="emailsecurity">
                                <div class="card mb-4 b-radius15 upping cursor-p noshadow bg-seccolorstyle">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text text-dark seccolor"><small>Powerful protection for emails
                                                with
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img class="svg img-fluid rounded-start"
                                                src="./assets/fonts/svg/cloudfiber.svg" alt="Shared Hosting">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                            ...
                            <a href="domains">
                                <div class="card mb-4 b-radius15 upping cursor-p noshadow bg-seccolorstyle">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img class="svg img-fluid rounded-start"
                                                src="./assets/fonts/svg/domains.svg" alt="Email Security">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                            ...
                            <a href="ssl">
                                <div class="card mb-4 b-radius15 upping cursor-p noshadow bg-seccolorstyle">
                                    ...
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img class="svg img-fluid rounded-start"
                                                src="./assets/fonts/svg/privacy.svg" alt="Wilcard SSL">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <h6 class="card-title text-dark mergecolor">Wilcard</h6>
                                                <p class="card-text text-dark seccolor"><small>Security, credibility and
                                                        trust
                                                        visitors..</small></p>
                                            </div>
                                        </div>
            ...
            <section id="drop-lng" class="btn-group btn-group-toggle toplang">
                <label data-lng="en-US" for="option1" class="btn btn-secondary me-2 styletextDirection"
                    data-value="ltr">
                ...
                <label data-lng="ar-AR" for="option3" class="btn btn-secondary me-2 styletextDirection"
                    data-value="rtl">
                    <input type="radio" name="options" id="option3"> AR
                </label>
                <label data-lng="es-ES" for="option4" class="btn btn-secondary styletextDirection" data-value="ltr">
